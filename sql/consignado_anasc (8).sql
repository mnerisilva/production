...
--
-- Host: 127.0.0.1
-- Generation Time: 02-Out-2020 às 04:40
...
(23, 10, '', 1, 2, '', 156, 1, 1, 1, 3, 1, 156, 178, 0, '2020-10-02 01:13:58', '', '0000-00-00 00:00:00');
...
--
ALTER TABLE `tab_anexos`
  MODIFY `id_anexo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;
