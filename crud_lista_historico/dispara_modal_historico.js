          ...
          $.ajax({
            ...
            success: function (data) {
                ...
                for (let key in objeto_data_hist) {
                    ...
                    $('#crudHistorico .table-historico tbody').append('<tr><th scope="row">'+linha.id_hist+'</th><td>'+linha.data_ult_modi+'</td><td>'+linha.postagem_hist+'</td><td>'+linha.id_user+'</td></tr>')
