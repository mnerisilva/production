          ...
          $.ajax({
            ...
            success: function (data) {
                ...
                for (let key in objeto_data_hist) {
                    ...
                    $('.post-list').append('<div class="container-post" style="display: flex; justify-content: flex-start; align-items: end;"><div class="img-user" style="margin-right: 5px;"><img src="'+linha.foto_usuario_link+'" class="img-responsive" title="'+linha.primeiro_nome_usuario+'" /></div><div><div class="div-do-post">'+linha.postagem_hist+'</div><div class="div-do-icone-edit-post"><a href="" style="margin-right: .5em;"><i class="fa fa-trash"></i></a> <a href=""><i class="fa fa-edit"></i></a></div></div></div>');
